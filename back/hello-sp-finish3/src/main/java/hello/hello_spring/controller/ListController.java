...
public class ListController {
    ...
    @PostMapping
    @Operation(summary = "새로운 TodoList 생성", description = "사용자가 새로운 TodoList를 생성합니다.")
    ...
    @GetMapping
    @Operation(summary = "작성한 TodoList 불러오기", description = "사용자가 작성한 TodoList를 불러옵니다.")
    ...
    @PutMapping
    @Operation(summary = "작성한 TodoList 수정", description = "사용자가 작성한 TodoList를 수정합니다.")
    public ResponseEntity<TodoList> updateTodo(
            @RequestBody FixListForm form,
            HttpServletRequest request
    ) {
        Long memberId = (Long) request.getAttribute("memberId");
        if (memberId == null) {
    ...
    @DeleteMapping
    @Operation(summary = "작성한 TodoList 삭제", description = "사용자가 작성한 TodoList를 삭제합니다.")
